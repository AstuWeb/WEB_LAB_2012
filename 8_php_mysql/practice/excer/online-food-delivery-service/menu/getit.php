...
$run2 =mysqli_query($con,"update mgetit set qty=qty-1 where name='$name';");
$run3=mysqli_query($con,"update mgetit set qty=10 where qty=3;");
if($run1 && $run2)
{
	mysqli_commit($con);
  header("LOCATION:menugetit.html");
}
else
{
	echo "Not inserted";

...
<div id="sidebar">
	...
	<img src ="http://localhost/Akshay/Admission/HeaderLogo.jpg" width="100%"><br><center>
	<p style="background-color:rgb(60, 60, 60);"><marquee style="font-family:Lucida Calligraphy;color:rgb(240, 240, 240); font-size:20px;">Sir Visvesvaraya Institude of Technology Chincholi, Nashik</marquee><p>
		<div class="ct">
			<h1 style="color:rgb(240, 240, 240);"><br><center style="font-family:Lucida Calligraphy; font-size:50px; background-color:rgb(60, 60, 60);">About the Society</center></h1>
		</div>
